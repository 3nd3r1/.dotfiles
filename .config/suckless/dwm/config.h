...
static const char *scrot[]  = { "scrot", "-s", "-d3", "/home/viljami/Pictures/Screenshots/%Y-%m-%d-%s_$wx$h.jpg", NULL };
...
static const Key keys[] = {
	...
	{SUPER, XK_plus, spawn, SHCMD("~/.local/bin/volumeControl up")},
	{0, XF86XK_AudioRaiseVolume, spawn, SHCMD("~/.local/bin/volumeControl up")},

	{SUPER, XK_minus, spawn, SHCMD("~/.local/bin/volumeControl down")},
	{0, XF86XK_AudioLowerVolume, spawn, SHCMD("~/.local/bin/volumeControl down")},
