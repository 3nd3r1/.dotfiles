...
plugins=(git nvm zoxide tmux vi-mode zsh-autosuggestions zsh-syntax-highlighting helm kubectl docker fzf golang brew gcloud poetry-env poetry virtualenv rust)
